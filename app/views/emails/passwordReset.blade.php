...
<html lang="en-US">
	...
	<body style="background-color:#b7b9bb;"> <!-- change all image paths from hosting when site goes up -->
		...
		<div id="title" style="width: 99.7%; border:1px solid; border-color:  #dfe0df;">
			...
			<h1 style="text-align:center; font-family: 'Lato', sans-serif;">Forgotten Password</h1>
		</div>
		<div id="content" style="width: 99.7%; border:1px solid; border-color:  #dfe0df;">
			<div id="text_content" style="width:  90%; margin:0 auto;">
				...
				<ul>
					<li style="font-family: 'Lato', sans-serif;">Click <a href="{{URL::to('login')}}">
						here if it was a mistake</a>.
					</li>
					<li style="font-family: 'Lato', sans-serif;">
						Click <a href="{{URL::to('pwreset/reset')}}/{{$code}}">here to reset</a>. (this link will expire on {{$expDate}} )
					</li>
				</ul>
			</div>
		</div>
