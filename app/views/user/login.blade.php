...
<div class="row" id="loginHeader">
		...
		<div class="row-register">
			...
			<div class="col-md-4">
			    ...
			    {{'<div id="check-section"><input type="checkbox" name="persistent" value="yes" id="check-section-checkbox" /><label for="check-section-checkbox">Remember Me</label></div>'}}
...
<!--			    {{Form::text('email', Input::get('email'), ["id"=>"placeLogin",'placeholder' => 'E-mail', 'class' => 'form-control'])}} -->
			...
			<div class="col-md-4">
				...
				{{'<div id="check-section-reg"><input type="checkbox" name="persistent" id="check-section-reg-checkbox" value="yes"></input><label for="check-section-reg-checkbox">Remember Me</label></div>'}}
